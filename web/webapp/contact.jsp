...
<html lang="en">
  ...
  <body>
    ...
    <div class="templateux-cover" style="background-image: url(images/index_develop_bg3.jpg);">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <br><br><br>
            <h6 data-aos="fade-up "  class="font-weight-bold font-italic heading">联系我们</h6>
            <h1 class="heading mb-3" data-aos="fade-up">小组工作安排</h1>
            <div class="col-md-3">
              <div class="block-footer-widget">
                <a href="./fileResources/taskScheduling.pdf" class="btn btn-primary">1.获取PDF</a>
                </div>
            </div>
           <!--  -->
            <br>
           <!--  -->
            <div class="col-md-4">
              <div class="block-footer-widget">
                <a href="./webPageCodeFile.zip" class="btn btn-primary">2.获取网页文件(最近一次提交时间2023年5月6日11:00:18)</a>
                </div>
            </div>
            <!--  -->
              </div>
