...
<html lang="en">
  ...
  <body>
    ...
    <div class="templateux-cover" style="background-image: url(images/slider-4.jpg);">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <h6 data-aos="fade-up">新闻资讯</h6>
            <h1 class="heading mb-3" data-aos="fade-up">Description of the news information</h1>
          </div>
        </div>
      </div>
