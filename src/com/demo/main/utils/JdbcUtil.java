...
public final class JdbcUtil {
  ...
  private static void config() {
     ...
     * 获取URL
     */
    // jdbc:mysql://localhost:3306/message_board?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai
    // jdbc:mysql://localhost:3306/message_board?useUnicode=true&characterEncoding=utf8&useSSL=true&serverTimezone=Asia/Shanghai
    URL = "jdbc:mysql://localhost:3306/message_board?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai";
    /*
     * 获取用户名
     */
    username = "root";
  ...
  public static void transaction() {
    ...
    try {
      ...
      System.out.println(
          "设置事务的提交方式为 : " + (autoCommit ? "自动提交" : "手动提交") + " 时失败: " + e.getMessage());
    }
  }
